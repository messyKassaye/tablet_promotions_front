        ...
        return (
            <Card>
                <CardHeader
                 ...
                 subheader={<Typography component={Link} style={{textDecoration:'none',color:grey[500],fontSize:14}} to={`/auth/company/${this.props.advert.company.id}`}>{this.props.advert.company.name}</Typography>}
                    ...
                    <Table>
                        <TableBody>
                            <TableRow>
                                ...
                                <TableCell className={classes.customTableCell}>{this.props.advert.media.name}</TableCell>
                            </TableRow>
                            ...
                            <TableRow>
                                ...
                                <TableCell className={classes.customTableCell}>{this.props.advert.required_views_number.toLocaleString()}</TableCell>
                            </TableRow>
                            ...
                            <TableRow>
                                ...
                                <TableCell className={classes.customTableCell}>{this.props.advert.views.length}</TableCell>
                            </TableRow>
